            ...
            <div class="login-html">
                <div class="span7">   
                    <div class="widget stacked widget-table action-table">
                        <input id="signin" type="radio" name="tab" class="sign-in" checked><label for="signin" class="tab">My accounts</label>
                            ...
                            <table class="table table-striped table-bordered" style="color: #fff">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-actions">
                                            <a href="/NewsApp-war/web/bank/<%=((List) request.getAttribute("basketListId")).get(i)%>" class="btn btn-small btn-primary">
